    ...
    <div class="contract-document" id="pdf-area">
      ...
      <table class="document-table">
        <tr>
          <td colspan="6" class="section-intro">
            임대인({{ contract.lessorName }})과 임차인({{
              contract.lesseeName
            }})은 아래 표시 부동산에 관하여 다음 계약 내용과 같이 임대차계약을
            체결한다.<br /><br />
            1. 부동산의 표시
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="5">
            {{ contract.leasedPart }} ({{ formatArea(contract.leasedArea) }})
          </td>
        </tr>
      </table>
      ...
      <table class="document-table">
        <tr>
          <td colspan="6" class="section-intro">
            2. 계약 내용<br />
            제1조 (목적) 위 부동산의 임대차에 한하여 임대인과 임차인은 합의에
      ...
      <table class="document-table">
        <tr>
          <td colspan="6" class="clause-cell">
            제2조 (존속기간) 임대인은 위 부동산을 임대차 목적대로 사용·수익할 수
            있는 상태로 {{ formatDate(contract.leaseStart) }} 까지 임차인에게
            인도하며, 임대차 기간은 인도일로부터
            {{ formatDate(contract.leaseEnd) }} 까지로 한다.<br /><br />
            제3조 (용도변경 및 전대 등) 임차인은 임대인의 동의 없이 위 부동산의
            용도나 구조를 변경하거나 전대·임차권 양도 또는 담보제공을 하지
            못하며 임대차 목적 이외의 용도로 사용할 수 없다.<br /><br />
            제4조 (계약의 해지) 임차인의 차임연체액이 2기의 차임액에 달하거나
            제3조를 위반하였을 때 임대인은 즉시 본 계약을 해지할 수 있다.<br /><br />
            제5조 (계약의 종료) 임대차계약이 종료된 경우에 임차인은 위 부동산을
            원상으로 회복하여 임대인에게 반환한다. 이러한 경우 임대인은 보증금을
            임차인에게 반환하고, 연체 임대료 또는 손해배상금이 있을 때는 이를
            제하고 그 잔액을 반환한다.<br /><br />
            제6조 (계약의 해제) 임차인이 임대인에게 중도금(중도금이 없을 때는
            잔금)을 지불하기 전까지, 임대인은 계약금의 배액을 상환하고, 임차인은
            계약금을 포기하고 이 계약을 해제할 수 있다.<br /><br />
            제7조 (채무불이행과 손해배상) 임대인 또는 임차인이 본 계약상의
            내용에 대하여 불이행이 있을 경우 그 상대방은 불이행한 자에 대하여
            서면으로 최고하고 계약을 해제할 수 있다. 그리고 계약 당사자는
      ...
      <table class="document-table">
        <tr>
          <td colspan="6" class="proof-text">
            ...
            서명·날인 후 임대인, 임차인 매 장마다 간인하여야 하며, 각각 1통씩
            보관한다.
          </td>
        </tr>
      </table>
